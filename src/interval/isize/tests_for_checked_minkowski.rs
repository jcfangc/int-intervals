...
mod unit_tests {
    ...
    fn test_minkowski_add_basic() {
        let a = IsizeCO::try_new(1, 5).unwrap();
        let b = IsizeCO::try_new(-3, 2).unwrap();
    ...
    fn test_minkowski_sub_basic() {
        let a = IsizeCO::try_new(5, 10).unwrap();
        let b = IsizeCO::try_new(2, 4).unwrap();
    ...
    fn test_minkowski_mul_basic() {
        let a = IsizeCO::try_new(-2, 3).unwrap(); // [-2,3)
        let b = IsizeCO::try_new(-1, 2).unwrap(); // [-1,2)
    ...
    fn test_minkowski_div_basic() {
        let a = IsizeCO::try_new(-4, 10).unwrap();
        let b = IsizeCO::try_new(2, 5).unwrap();
    ...
    fn test_minkowski_div_by_zero() {
        let a = IsizeCO::try_new(1, 5).unwrap();
        let b = IsizeCO::try_new(0, 3).unwrap();
...
mod prop_tests {
    ...
    fn interval_strategy() -> impl Strategy<Value = IsizeCO> {
        prop_oneof![
            Just(IsizeCO::try_new(isize::MIN, isize::MIN + 1).unwrap()), // [-128, -127)
            Just(IsizeCO::try_new(isize::MIN, isize::MAX).unwrap()),     // [-128, 127)
            Just(IsizeCO::try_new(isize::MAX - 1, isize::MAX).unwrap()), // [126, 127)
            (isize::MIN..=isize::MAX, isize::MIN..=isize::MAX)
                .prop_filter_map("valid interval", |(s, e)| IsizeCO::try_new(s, e))
        ]
    }

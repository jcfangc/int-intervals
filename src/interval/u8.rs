...
mod basic {
    ...
    impl U8CO {
        ...
        /// Construct a `U8CO` from a start position and a length.
        ///
        /// The resulting interval is `[start, start + len)`.
        ///
        /// Returns `None` if:
        /// - `len == 0`;
        /// - `start + len` overflows `u8`.
        #[inline]
        pub const fn checked_from_start_len(start: u8, len: u8) -> Option<Self> {
            if len == 0 {
                return None;
            }
        ...
        /// Returns `None` if:
        /// - `len == 0`;
        /// - saturation still produces an empty interval, e.g. `start == u8::MAX`.
        #[inline]
        pub const fn saturating_from_start_len(start: u8, len: u8) -> Option<Self> {
            if len == 0 {
                return None;
            }
        ...
        ///
        /// Returns `None` if the computed interval is invalid or overflows u8.
        #[inline]
        pub const fn checked_from_midpoint_len(mid: u8, len: u8) -> Option<Self> {
            if len == 0 {
                return None;
            }
            ...
            // 1. `mid.checked_sub(len / 2)` ensures `start` does not underflow `u8`.
            // 2. `start.checked_add(len)` ensures `end_excl` does not overflow `u8`.
        ...
        #[inline]
        pub const fn saturating_from_midpoint_len(mid: u8, len: u8) -> Option<Self> {
            if len == 0 {
                return None;
            }
    ...
    impl U8CO {
        ...
        #[inline]
        pub const fn to_range(self) -> core::ops::Range<u8> {
            self.start..self.end_excl
        }
    }
}
...
// ------------------------------------------------------------
// Module: Minkowski arithmetic for U8CO
...
pub mod minkowski {
    ...
    pub mod checked {
        ...
        impl U8CO {
            ...
            #[inline]
            pub const fn checked_minkowski_add_scalar(self, n: u8) -> Option<Self> {
            ...
            #[inline]
            pub const fn checked_minkowski_sub_scalar(self, n: u8) -> Option<Self> {
            ...
            #[inline]
            pub const fn checked_minkowski_mul_scalar_hull(self, n: u8) -> Option<Self> {
            ...
            #[inline]
            pub const fn checked_minkowski_div_scalar_hull(self, n: u8) -> Option<Self> {
                if n == 0 {
                    return None;
                }
    ...
    pub mod saturating {
        ...
        impl U8CO {
            ...
            #[inline]
            pub const fn saturating_minkowski_add_scalar(self, n: u8) -> Option<Self> {
            ...
            #[inline]
            pub const fn saturating_minkowski_sub_scalar(self, n: u8) -> Option<Self> {
            ...
            #[inline]
            pub const fn saturating_minkowski_mul_scalar_hull(self, n: u8) -> Option<Self> {
            ...
            #[inline]
            pub const fn saturating_minkowski_div_scalar_hull(self, n: u8) -> Option<Self> {
                if n == 0 {
                    return None;
                }
...
crate::interval::traits::impl_co_forwarding!(U8CO, u8, u8);

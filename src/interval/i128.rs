...
mod basic {
    ...
    impl I128CO {
        ...
        #[inline]
        pub const fn iter(self) -> core::ops::Range<i128> {
            self.start..self.end_excl
        }

        #[inline]
        pub const fn to_range(self) -> core::ops::Range<i128> {
            self.start..self.end_excl
        }
...
// ------------------------------------------------------------
// Module: Minkowski arithmetic for I128CO
...
pub mod minkowski {
    ...
    #[inline]
    const fn min_max4(a: i128, b: i128, c: i128, d: i128) -> (Min, Max) {
    ...
    #[inline]
    const fn min_max2(a: i128, b: i128) -> (Min, Max) {
        if a < b { (a, b) } else { (b, a) }
    }
...
crate::interval::traits::impl_co_forwarding!(I128CO, i128, u128);

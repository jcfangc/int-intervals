...
mod basic {
    ...
    impl I64CO {
        ...
        #[inline]
        pub const unsafe fn new_unchecked(start: i64, end_excl: i64) -> Self {
            debug_assert!(start < end_excl);
            Self { start, end_excl }
        }

        /// Constructs an `I64CO` interval from a midpoint and length (`u64`).
        ///
        /// # Parameters
        /// - `mid`: the desired midpoint of the interval
        /// - `len`: the desired length of the interval in units, must be `1..=u64::MAX`
        ///
        /// # Returns
        /// - `Some(I64CO)` if the interval `[start, end_excl)` can be represented in `i64`
        /// - `None` if `len = 0` or the computed `start` / `end_excl` would overflow `i64`
        ///
        /// # Guarantees
        /// - Returned interval satisfies `start < end_excl`
        /// - Maximum accepted input length is `u64::MAX`
        #[inline]
        pub const fn checked_from_midpoint_len(mid: i64, len: u64) -> Option<Self> {
            if len == 0 {
                return None;
            }
            ...
            let Some(end_excl) = end_incl.checked_add((len % 2) as i64) else {
                return None;
            };
            ...
            // 1. `mid.checked_sub(half)` ensures `start` does not underflow `i64`.
            // 2. `mid.checked_add(the_other_half)` ensures `end_excl` does not overflow `i64`.
        ...
        /// Constructs an `I64CO` interval from a midpoint and length (`u64`) with saturating semantics.
        ///
        /// # Parameters
        /// - `mid`: the desired midpoint of the interval
        /// - `len`: the desired length of the interval in units, must be `1..=u64::MAX`
        ///
        /// # Behavior
        /// - Values are saturated at `i64::MIN` / `i64::MAX` to prevent overflow.
        ...
        #[inline]
        pub const fn saturating_from_midpoint_len(mid: i64, len: u64) -> Option<Self> {
            if len == 0 {
                return None;
            }
            ...
            let end_excl = end_incl.saturating_add((len % 2) as i64);
    ...
    #[inline]
    const fn checked_end_excl_from_start_len(start: i64, len: u64) -> Option<i64> {
        end_excl_from_start_len(start, len, false)
    }

    #[inline]
    const fn saturating_end_excl_from_start_len(start: i64, len: u64) -> Option<i64> {
    ...
    #[inline]
    const fn end_excl_from_start_len(start: i64, len: u64, saturating: bool) -> Option<i64> {
        if len == 0 {
            return None;
        }

        if start < 0 {
            let to_zero = if start == i64::MIN {
                (i64::MAX as u64) + 1
            } else {
                (-start) as u64
            };
            ...
            if len < to_zero {
                let Some(end_excl) = start.checked_add(len as i64) else {
                    return None;
                };
                Some(end_excl)
            } else if len == to_zero {
                ...
                if rem > i64::MAX as u64 {
                    if saturating { Some(i64::MAX) } else { None }
                } else {
                    Some(rem as i64)
                }
            }
        } else {
            let room = (i64::MAX - start) as u64;
    ...
    impl I64CO {
        /// Constructs an `I64CO` interval from a start position and length.
        ///
        ...
        /// Returns `None` if:
        /// - `len == 0`;
        /// - `start + len` would exceed `i64::MAX`.
        #[inline]
        pub const fn checked_from_start_len(start: i64, len: u64) -> Option<Self> {
        ...
        /// Constructs an `I64CO` interval from a start position and length,
        /// saturating the exclusive end bound at `i64::MAX`.
        ///
        /// The resulting interval is `[start, saturated_end_excl)`.
        ///
        /// Returns `None` if:
        /// - `len == 0`;
        /// - saturation still produces an empty interval, e.g. `start == i64::MAX`.
        #[inline]
        pub const fn saturating_from_start_len(start: i64, len: u64) -> Option<Self> {
    ...
    impl I64CO {
        ...
        /// - Works for intervals with maximum length (entire `i64` range)
        #[inline]
        pub const fn midpoint(self) -> i64 {
            self.start + (self.len() / 2) as i64
        }
        ...
        #[inline]
        pub const fn to_range(self) -> core::ops::Range<i64> {
            self.start..self.end_excl
        }
...
pub mod minkowski {
    ...
    #[inline]
    const fn min_max4(a: i64, b: i64, c: i64, d: i64) -> (Min, Max) {
    ...
    #[inline]
    const fn min_max2(a: i64, b: i64) -> (Min, Max) {
        if a < b { (a, b) } else { (b, a) }
    }
    ...
    pub mod checked {
        ...
        impl I64CO {
            #[inline]
            pub const fn checked_minkowski_add_scalar(self, n: i64) -> Option<Self> {
            ...
            #[inline]
            pub const fn checked_minkowski_sub_scalar(self, n: i64) -> Option<Self> {
            ...
            #[inline]
            pub const fn checked_minkowski_mul_scalar_hull(self, n: i64) -> Option<Self> {
            ...
            #[inline]
            pub const fn checked_minkowski_div_scalar_hull(self, n: i64) -> Option<Self> {
                if n == 0 {
                    return None;
                }
    ...
    pub mod saturating {
        ...
        impl I64CO {
            #[inline]
            pub const fn saturating_minkowski_add_scalar(self, n: i64) -> Option<Self> {
            ...
            #[inline]
            pub const fn saturating_minkowski_sub_scalar(self, n: i64) -> Option<Self> {
            ...
            #[inline]
            pub const fn saturating_minkowski_mul_scalar_hull(self, n: i64) -> Option<Self> {
            ...
            #[inline]
            pub const fn saturating_minkowski_div_scalar_hull(self, n: i64) -> Option<Self> {
                if n == 0 {
                    return None;
                }
...
crate::interval::traits::impl_co_forwarding!(I64CO, i64, u64);

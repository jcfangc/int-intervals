...
mod unit_tests {
    ...
    fn span(lo: i64, hi: i64) -> I64CO {
        I64CO::try_new(lo, hi).unwrap()
    }
...
mod prop_tests {
    ...
    fn span(a: i64, b: i64) -> Option<I64CO> {
        let lo = a.min(b);
        let hi = a.max(b);
        I64CO::try_new(lo, hi)
    }
    ...
    fn edge_values() -> Vec<i64> {
        let mut v = vec![i64::MIN, i64::MAX, 0, 1];

        if i64::MIN < i64::MAX {
            v.push(i64::MIN.saturating_add(1));
            v.push(i64::MAX.saturating_sub(1));
        }
    ...
    fn edge_scalar() -> impl Strategy<Value = i64> {
    ...
    fn span_strategy() -> impl Strategy<Value = I64CO> {
        (mixed_scalar(), mixed_scalar()).prop_filter_map("non-empty interval", |(a, b)| span(a, b))
    }

    fn union_contains(u: OneTwo<I64CO>, p: i64) -> bool {
        match u {
        ...
        fn union_shape_is_correct(
            ...
            match x.union(y) {
                ...
                OneTwo::One(z) => {
                    ...
                    prop_assert_eq!(z, I64CO::try_new(start, end_excl).unwrap());
                }

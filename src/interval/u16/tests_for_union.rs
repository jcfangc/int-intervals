...
mod prop_tests {
    ...
    fn span(a: u16, b: u16) -> Option<U16CO> {
        let lo = a.min(b);
        let hi = a.max(b);
        U16CO::try_new(lo, hi)
    }
    ...
    fn span_strategy() -> impl Strategy<Value = U16CO> {
        (mixed_scalar(), mixed_scalar()).prop_filter_map("non-empty interval", |(a, b)| span(a, b))
    }

    fn union_contains(u: OneTwo<U16CO>, p: u16) -> bool {
        match u {
        ...
        fn union_shape_is_correct(
            ...
            match x.union(y) {
                ...
                OneTwo::One(z) => {
                    ...
                    prop_assert_eq!(z, U16CO::try_new(start, end_excl).unwrap());
                }

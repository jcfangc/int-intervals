...
mod unit_tests {
    ...
    fn test_saturating_minkowski_add_basic() {
        ...
        let b = U16CO::try_new(2, 4).unwrap();
    ...
    fn test_saturating_minkowski_sub_basic() {
        let a = U16CO::try_new(5, 10).unwrap();
        let b = U16CO::try_new(2, 4).unwrap();
    ...
    fn test_saturating_add_can_collapse_to_none() {
        let a = U16CO::try_new(u16::MAX - 5, u16::MAX).unwrap(); // [250,255)
        let b = U16CO::try_new(10, 20).unwrap(); // [10,20)
...
mod prop_tests {
    ...
    fn interval_strategy() -> impl Strategy<Value = U16CO> {
        prop_oneof![
            Just(U16CO::try_new(u16::MIN, u16::MIN + 1).unwrap()), // [0,1)
            Just(U16CO::try_new(u16::MIN, u16::MAX).unwrap()),     // [0,255)
            Just(U16CO::try_new(u16::MAX - 1, u16::MAX).unwrap()), // [254,255)
            (u16::MIN..=u16::MAX, u16::MIN..=u16::MAX)
                .prop_filter_map("valid interval", |(s, e)| U16CO::try_new(s, e))
        ]
    }

    fn scalar_strategy() -> impl Strategy<Value = u16> {
        prop_oneof![Just(0), Just(1), Just(u16::MAX), any::<u16>()]
    }

    #[inline]
    fn endpoints(x: U16CO) -> [u16; 2] {
        [x.start(), x.end_incl()]
    }

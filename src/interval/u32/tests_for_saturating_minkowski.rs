...
mod unit_tests {
    ...
    fn test_saturating_minkowski_mul_basic() {
        let a = U32CO::try_new(1, 4).unwrap();
        let b = U32CO::try_new(2, 3).unwrap();
    ...
    fn test_saturating_add_can_collapse_to_none() {
        let a = U32CO::try_new(u32::MAX - 5, u32::MAX).unwrap(); // [250,255)
        let b = U32CO::try_new(10, 20).unwrap(); // [10,20)
        assert!(a.saturating_minkowski_add(b).is_none());
    }

    #[test]
    fn test_saturating_mul_can_collapse_to_none() {
        let a = U32CO::try_new(u32::MAX - 5, u32::MAX).unwrap();
        let b = U32CO::try_new(2, 3).unwrap();
    ...
    fn test_saturating_sub_n_can_collapse_to_none() {
        let a = U32CO::try_new(1, 3).unwrap();

...
mod basic {
    ...
    impl I16CO {
        ...
        /// Constructs an `I16CO` interval from a midpoint and length (`u16`).
        ///
        /// # Parameters
        /// - `mid`: the desired midpoint of the interval
        /// - `len`: the desired length of the interval in units, must be `1..=u16::MAX`
        ///
        /// # Returns
        /// - `Some(I16CO)` if the interval `[start, end_excl)` can be represented in `i16`
        /// - `None` if `len = 0` or the computed `start` / `end_excl` would overflow `i16`
        ///
        /// # Guarantees
        /// - Returned interval satisfies `start < end_excl`
        /// - Maximum accepted input length is `u16::MAX`
        #[inline]
        pub const fn checked_from_midpoint_len(mid: i16, len: u16) -> Option<Self> {
            if len == 0 {
                return None;
            }

            let half = (len / 2) as i16;
            ...
            let Some(end_excl) = end_incl.checked_add((len % 2) as i16) else {
                return None;
            };
            ...
            // 1. `mid.checked_sub(half)` ensures `start` does not underflow `i16`.
            // 2. `mid.checked_add(the_other_half)` ensures `end_excl` does not overflow `i16`.
        ...
        /// Constructs an `I16CO` interval from a midpoint and length (`u16`) with saturating semantics.
        ///
        /// # Parameters
        /// - `mid`: the desired midpoint of the interval
        /// - `len`: the desired length of the interval in units, must be `1..=u16::MAX`
        ///
        /// # Behavior
        /// - Values are saturated at `i16::MIN` / `i16::MAX` to prevent overflow.
        ...
        #[inline]
        pub const fn saturating_from_midpoint_len(mid: i16, len: u16) -> Option<Self> {
            if len == 0 {
                return None;
            }
            ...
            let end_excl = end_incl.saturating_add((len % 2) as i16);
    ...
    #[inline]
    const fn checked_end_excl_from_start_len(start: i16, len: u16) -> Option<i16> {
        end_excl_from_start_len(start, len, false)
    }

    #[inline]
    const fn saturating_end_excl_from_start_len(start: i16, len: u16) -> Option<i16> {
    ...
    #[inline]
    const fn end_excl_from_start_len(start: i16, len: u16, saturating: bool) -> Option<i16> {
        if len == 0 {
            return None;
        }

        if start < 0 {
            let to_zero = if start == i16::MIN {
                (i16::MAX as u16) + 1
            } else {
                (-start) as u16
            };
            ...
            if len < to_zero {
                let Some(end_excl) = start.checked_add(len as i16) else {
                    return None;
                };
                Some(end_excl)
            } else if len == to_zero {
                ...
                if rem > i16::MAX as u16 {
                    if saturating { Some(i16::MAX) } else { None }
                } else {
                    Some(rem as i16)
                }
            }
        } else {
            let room = (i16::MAX - start) as u16;
    ...
    impl I16CO {
        /// Constructs an `I16CO` interval from a start position and length.
        ///
        ...
        /// Returns `None` if:
        /// - `len == 0`;
        /// - `start + len` would exceed `i16::MAX`.
        #[inline]
        pub const fn checked_from_start_len(start: i16, len: u16) -> Option<Self> {
        ...
        /// Constructs an `I16CO` interval from a start position and length,
        /// saturating the exclusive end bound at `i16::MAX`.
        ///
        /// The resulting interval is `[start, saturated_end_excl)`.
        ///
        /// Returns `None` if:
        /// - `len == 0`;
        /// - saturation still produces an empty interval, e.g. `start == i16::MAX`.
        #[inline]
        pub const fn saturating_from_start_len(start: i16, len: u16) -> Option<Self> {
    ...
    impl I16CO {
        ...
        pub const fn end_incl(self) -> i16 {
            // i16_low_bound =< start < end_excl
            self.end_excl - 1
        }

        #[inline]
        pub const fn len(self) -> u16 {
            const SIGN_MASK: u16 = 1 << (i16::BITS - 1);
            ((self.end_excl as u16) ^ SIGN_MASK) - ((self.start as u16) ^ SIGN_MASK)
        }
        ...
        /// - Works for intervals with maximum length (entire `i16` range)
        #[inline]
        pub const fn midpoint(self) -> i16 {
            self.start + (self.len() / 2) as i16
        }
        ...
        #[inline]
        pub const fn iter(self) -> core::ops::Range<i16> {
            self.start..self.end_excl
        }

        #[inline]
        pub const fn to_range(self) -> core::ops::Range<i16> {
            self.start..self.end_excl
        }
...
// ------------------------------------------------------------
// Module: Minkowski arithmetic for I16CO
...
pub mod minkowski {
    ...
    #[inline]
    const fn min_max4(a: i16, b: i16, c: i16, d: i16) -> (Min, Max) {
    ...
    #[inline]
    const fn min_max2(a: i16, b: i16) -> (Min, Max) {
        if a < b { (a, b) } else { (b, a) }
    }
    ...
    pub mod checked {
        ...
        impl I16CO {
            #[inline]
            pub const fn checked_minkowski_add_scalar(self, n: i16) -> Option<Self> {
            ...
            #[inline]
            pub const fn checked_minkowski_sub_scalar(self, n: i16) -> Option<Self> {
            ...
            #[inline]
            pub const fn checked_minkowski_mul_scalar_hull(self, n: i16) -> Option<Self> {
            ...
            #[inline]
            pub const fn checked_minkowski_div_scalar_hull(self, n: i16) -> Option<Self> {
                if n == 0 {
                    return None;
                }
    ...
    pub mod saturating {
        ...
        impl I16CO {
            #[inline]
            pub const fn saturating_minkowski_add_scalar(self, n: i16) -> Option<Self> {
            ...
            #[inline]
            pub const fn saturating_minkowski_sub_scalar(self, n: i16) -> Option<Self> {
            ...
            #[inline]
            pub const fn saturating_minkowski_mul_scalar_hull(self, n: i16) -> Option<Self> {
            ...
            #[inline]
            pub const fn saturating_minkowski_div_scalar_hull(self, n: i16) -> Option<Self> {
                if n == 0 {
                    return None;
                }
...
crate::interval::traits::impl_co_forwarding!(I16CO, i16, u16);

...
mod basic {
    ...
    impl UsizeCO {
        ...
        /// Construct a `UsizeCO` from a start position and a length.
        ///
        ...
        #[inline]
        pub const fn checked_from_start_len(start: usize, len: usize) -> Option<Self> {
            if len == 0 {
                return None;
            }
        ...
        /// Returns `None` if:
        /// - `len == 0`;
        /// - saturation still produces an empty interval, e.g. `start == usize::MAX`.
        #[inline]
        pub const fn saturating_from_start_len(start: usize, len: usize) -> Option<Self> {
            if len == 0 {
                return None;
            }
...
crate::interval::traits::impl_co_forwarding!(UsizeCO, usize, usize);

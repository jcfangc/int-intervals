...
mod unit_tests {
    ...
    fn span(lo: i128, hi: i128) -> I128CO {
        I128CO::try_new(lo, hi).unwrap()
    }
...
mod prop_tests {
    ...
    fn union_contains(u: OneTwo<I128CO>, p: i128) -> bool {
        match u {
        ...
        fn union_shape_is_correct(
            ...
            match x.union(y) {
                ...
                OneTwo::One(z) => {
                    ...
                    prop_assert_eq!(z, I128CO::try_new(start, end_excl).unwrap());
                }
